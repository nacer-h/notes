...
\begin{figure}[h]
    \centering
    \includegraphics[width=25pc]{plots/top_view_detector_dedx.png}
...
\begin{figure}[h]
    \centering
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/dedxavtrack_before_trunc.png}
    \end{minipage}\hspace{3pc}%
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/dedxavtrack_after_trunc.png}
    \end{minipage}
...
\begin{figure}[h]
    \centering
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/cdedxp_proton_0_0.eps}
    \end{minipage}\hspace{3pc}%
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/cdedxp_pip_0_0.eps}
    \end{minipage}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=25pc]{plots/dedxav_proton_pip_misid.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=40pc]{plots/dedxav_proton_pip_all.eps}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=40pc]{plots/cpthetamisid_all_proton_pip.eps}
...
\begin{figure}[h]
    \centering
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/ctruncmisidcorr_proton_pip.eps}
    \end{minipage}\hspace{3pc}%
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/ctruncsepcorr_proton_pip.eps}
    \end{minipage}
...
\begin{figure}[h]
    \centering
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/cmgergrmisidp_proton_pip.eps}
    \end{minipage}\hspace{3pc}%
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/cmgergrsepp_proton_pip.eps}
    \end{minipage}
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/cmgergrresp_proton.eps}
    \end{minipage}\hspace{3pc}%
    \begin{minipage}{18pc}
        \includegraphics[width=18pc]{plots/cmgergrresp_pip.eps}
    \end{minipage}
