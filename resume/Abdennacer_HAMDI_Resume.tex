...
%Section
\section{Summary of Ressearch Interests}
%\cvline{}{\Large PhD in Particle Physics}
\cvline{}{\small Currently i am a Ph.D researcher in hadron spectroscopy in my last year with the GlueX and PANDA experiments. The gopal of my research is to search for a hybrid meson candidate, the $Y(2175)$ state, in photoproduction with GlueX.
Over the years, thanks to my thirst for knowledge, I have gained extensive experience in Physics especially in particle and nuclear Physics. Along this path I have continued to improve my approach to problems always trying to implement optimal and generalized solution. 
Team work, the capacity to adapt to multicultural environment and the ability to coordinate and monitor scientific projects gained during my education and research internships. As a next step, i would like to join a research team in experimental physics. I am confident that i can contribute to the efforts of the team both, in the physics analysis and addressing the needs of the experiment in hardware and software developement.}
...
\cventry{2013 - 2015}{Master's degree in Particle Physics}{Blaise Pascal university - Science and Technology}{Clermont-Ferrand}{France}{} % arguments 3 to 6 are optional
\cventry{2005 - 2010}{Master's degree in Nuclear Physics}{Ferhat Abbas University}{Sétif}{Algeria}{} % arguments 3 to 6 are optional
...
\begin{itemize}
    \item Delivering an optimal mean energy loss truncation in GlueX Central Drift Chamber (CDC).
...
\cventry{}{Search for exotic states in photoproduction at GlueX}{}{}{}{GlueX Collaboration et al. 2019 arXiv:1905.10811}
...
\cventry{}{Strange Hadron Spectroscopy with a Secondary KL Beam at GlueX}{}{}{}{GlueX Collaboration (S. Adhikari (Florida Intl. U.) et al.) 2017 arXiv:1707.05284}
...
\hspace{25mm}Fluent in \textbf{English} and \textbf{French}, good \textbf{German}
...
\cvcomputer{Languages}{C/C++, Bash, Csh, \LaTeX}{}{}
