...
\cvline{}{\small Currently i am a Ph.D researcher in hadron spectroscopy in my last year with the GlueX and PANDA experiments. The goal of my current project is searching for a hybrid meson candidate, the $Y(2175)$ state, in photoproduction with GlueX. Over the years, thanks to my thirst for knowledge, I have gained extensive experience in Physics especially in particle and nuclear Physics. Along this path I have continued to improve my approach to problems always trying to implement optimal and generalized solution. 
