...
\address{Herzogstra{\ss}e 13-19}{60528 Frankfurt Am Main}{Germany}
...
% \photo[80pt]{photo/nacer_pic_2.jpg}
...
%\subsection{Academic}
\cventry{2016 - 2020}{Graduate Researcher}{GSI Helmholtz Centre}{Darmstadt}{Germany}{
\begin{itemize}
    ...
    \item Representing my team in the collaboration and in international conferences.
...
\cventry{2015 - 2016}{Sales Agent at Relay Travel Retail}{Clermont-Ferrand}{France}{}
{
    \begin{itemize}
...
%Section
\section{Personal}
\cvline{Aikido}{\small Developed self-confidence, discipline and rigor through the club trainings.}
\cvline{Swimming}{\small Learning together with my university team on different swimming styles.}
%, attracted by the philosophy of protecting yourself while also protecting your opponent.
