...
\usepackage[scale=0.94]{geometry} %0.9
...
\address{Herzogstrasse 13,}{60528, Frankfurt Am Main,}{Germany}
...
\begin{itemize}
    ...
    \item Representing my team in the collaboration during working group meetings.
...
\cventry{2014 - 2015}{Masters internships with international collaboration}{LPC}{Clermont-Ferrand}{France}
{
    \begin{itemize}
...
\hspace{25mm}Fluent in \textbf{English}, \textbf{French}, \textbf{Arabic} and \textbf{Bereber}, basic \textbf{German}
...
\cventry{August 2017}{Dramstdat-Gießen-Heidelberg Seminar on Hadron Spectroscopy}{Justus-Liebig-Universität Gießen}{Gießen}{Germany}{The GlueX Experiment} % arguments 3 to 6 are optional
